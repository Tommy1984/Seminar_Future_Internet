...
(SLA) entspricht festgelegt werden, wieviele zeitlich überlappende 
...
mit denen die Entfernung der Leistung im Normalbetrieb vom Optimum beeinflusst 
werden kann. 
Auf ähnliche Weise kann auch die für die durchschnittliche Verzögerungszeit für 
eine Ende-zu-End Übertragung beeinflusst werden. Hierzu wird \ref{tD2_LPSimple} 
ebenfalls durch zusätzliche Bedingungen ergänzt.
