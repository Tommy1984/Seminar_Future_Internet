...
So gesehen kann Routing auch wie in \cite{ApCo03} beschrieben als Fluss aufgefasst und dargestellt werden. 
Sei dazu $r$ ein Routing und der Graph $G=(V,E)$ das zu betrachtende Netzwerk, 
wobei $V$ der Menge der Router und $E$ der Menge der Verbindunge zwischen den Routern entspricht.
Ein Routing wird dann durch eine Menge $\{r_{ab}(e)|a,b \in V \land e \in E\}$ von Werten $r_{ab}(e)$ definiert, 
die angeben welcher Anbteil am Datenvolumen das von $a$ nach $b$ übertragen soll von der Verbindung $e$ getragen wird.
