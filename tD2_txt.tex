...
der Ausfallzeit und wie diese minimiert werden kann. 
Ein häufig verwendeter Ansatz ist die Vorberechnung von Alternativ-Routen und 
das schnell Umschalten im Fehlerfall. 
Dieser Ansatz bietet allerdings noch keine Möglichkeit um Stausituationen zu 
vermeiden oder die voraussichtliche Leistung nach einem Link-Fehler zu 
bestimmen.
...
Mitunter kann die Reorganisation des Routings für die neue Netztopologie sehr 
aufwendig zu berechnen und einzurichten sein.
Ein anderer Aspekt mit dem sich viele Arbeiten befassen ist die Tatsache, 
dass sich die Verkehrssituationen in einem Netz wie beispielsweise dem Internet 
