...
Heutige IP-basierte Netze wie beispielsweise das Internet, 
...
einer Vorberechnung und einer ständigen Rekonfiguration während des Netzbetriebs.
...
Auf dieser Grundlage wird ein weiteres Routing $p$ berechnet, was 

\subsection{Rekonfiguration}
