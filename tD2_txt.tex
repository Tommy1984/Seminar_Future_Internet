...
zu Empfänger $b$ entpsicht und $r_{ab}(e)$ dem wie oben beschriebenen Anteil.
...
Sologange die urspüngliche Netztopologie besteht, kann das reguläre Routing 
...
Erreicht lässt sich dies durch eine einfache Anpassung (re-scaling) der 
...
die konvexe Hülle einer Menge verschiedene Verkehrsmatrizen 
...
werden alle andern Router mittels ICMP über den Fehler informiert, so 
dass diese ihr Protection Routing entsprechend anpassen können.
