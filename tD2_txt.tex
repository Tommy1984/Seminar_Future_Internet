...
gefunden Routen ungültig und neue gesucht werden müssen. Gründe dafür sind 
...
als Fluss \cite{tD2_ApCo03} und das zugrundeliegende 
Computernetzwerk als Flussnetzwerk zu betrachten.
Häufig ist eine Pfad (Route) von einem Sender zur Empfänger nicht eindeutig, 
sondner es existieren mehrer Pfade für das Paar aus Sender und Empfänger. 
...
zum Empfänger $b$ entpsicht und $r_{ab}(e)$ dem wie oben beschriebenen Anteil.
...
fordert, dass jeder Zwischenknoten genausoviel weiterleitet wie an ihn gesendet 
wird.
